#!/usr/bin/env python3
"""
Minimal version of the sales agent app for immediate startup
"""
...
print("🚀 Starting Minimal Sales Agent...")

# --- Flask app setup ---
app = Flask(__name__)
app.config['SECRET_KEY'] = 'minimal-secret-key'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///minimal_sales.db'
...
def handle_connect():
    ...
    emit('connected', {'message': 'Connected to minimal sales agent'})
...
def handle_message(data):
    ...
    if user_details:
        ...
        agent_reply = f"I received: '{message}'. This is working perfectly!"
...
if __name__ == '__main__':
    print("\n" + "="*50)
    print("🚀 MINIMAL SALES AGENT")
    print("="*50)
    print(f"🌐 URL: http://localhost:5000")
    print(f"📊 CSV File: {CSV_FILE}")
    print("✅ Conversation flow working")
    print("❌ No background threads")
    print("❌ No RAG system")
